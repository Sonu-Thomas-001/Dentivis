    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <Dialog>
            {/* @ts-expect-error asChild standard type bug */}
            <DialogTrigger asChild>
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-6 shadow-md shadow-primary/20 transition-all active:scale-95">
                + New Treatment Plan
              </Button>
            </DialogTrigger>
